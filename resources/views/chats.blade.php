						...
						<div class="col-md-12">
							<div class="tab-content">
								...
								<div id="discussions" class="tab-pane fade active show">
									<div class="search">
										<form class="form-inline position-relative" action="{{ url('search') }}">
											<input type="search" class="form-control" id="conversations"  name="name" placeholder="Search for conversations...">
